		...
		>
			<div className='text-center'>
				<p className='text-3xl md:text-4xl lg:text-5xl pt-[0.8%]'>
					Controllers will be searched for by activating the vibration
					feature.
				</p>
				<p className='text-2xl md:text-3xl lg:text-4xl text-center pt-[1%] text-description'>
					Press ; or r on a searby controller to make the selected
					controller vibrate
				</p>
			</div>
			...
			<div className='text-2xl md:text-3xl lg:text-4xl flex gap-[5.5%] items-end px-[5%]'>
				...
				<button className='border-[3px] border-white w-full h-[6.6rem] bg-transparent rounded-lg outline-offset-[-3px]  outline-wiggle-focus hover:bg-blueHightTransparent focus-visible:bg-blueHightTransparent'>

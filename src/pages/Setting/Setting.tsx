...
function Setting() {
	...
	const options = [
		{
			name: t('setting.options.health-security'),
			path: '/health-security',
		},
		{ name: 'line', path: '' },
		{
			name: t('setting.options.airplane-mode'),
			path: '/airplane-mode',
		},
		{
			name: t('setting.options.screen-brighness'),
		...
		{ name: 'line', path: '' },
		{
			name: t('setting.options.parental-control'),
			path: '/parental-control',
		},
		{ name: t('setting.options.internet'), path: '/internet' },
		{
			name: t('setting.options.data-management'),
			path: '/data-management',
		},
		{
			name: t('setting.options.setting-user'),
			path: '/setting-user',
		},
		...
		{
			name: t('setting.options.notifications'),
			path: '/notifications',
		},
		{
		...
		{ name: 'line', path: '' },
		{
			name: t('setting.options.controls-sensors'),
	...
	return (
		...
		>
			...
			<section className='pr-12 overflow-auto scrollbar-hide'>
				<div
					tabIndex={-1}
					className='section-focus focus:outline-hidden px-[5.75rem] py-[4.2rem] text-[2.1rem] leading-normal'
				>
					<Outlet />
				</div>
			</section>

	...
	return (
		<ListPageTransition>
			<div className=' h-full w-full flex flex-col'>
				<SelectionSetting>Añadir dispositivo</SelectionSetting>

				<Detailtext>
					<p>
						Es necesario volver a conectar los dispositivos para usar audio por Bluetooth.
					</p>
					<ul className='list-image-checkmark pl-7 py-6'>
						...
						<li>El audio por Bluetooth se desconectarä al usar la comunicaciön local.</li>

...
function ViewGame () {
  return (
    <div className="flex">
      ...
      <Swiper
        className="w-screen flex overflow-x-scroll whitespace-nowrap scroll-smooth scrollbar-hide snap-x pl-[8.5%] pt-[0.6%]"
        spaceBetween={20}
        slidesPerView={'auto'}
        freeMode={true}
        modules={[FreeMode]}
      >
        {game.map(({ name, id, urlImage }) => (
          ...
          >
            ...
            <div className="flex outline-offset-4 outline-8 outline-[#15bffd] group-focus:outline group-focus:animate-wiggle shadow-Nbutton transition-all duration-100 2xl:w-[385px] 2xl:h-[385px] xl:w-[340px] xl:h-[300px] w-[300px] h-[300px]">
              <img
                src={urlImage}
